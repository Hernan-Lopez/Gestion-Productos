...
@OpenAPIDefinition(
    info = @Info(
        ...
        version = "1.0", 
        contact = @Contact(name = "misitio", email = "support@misitio.cl"),
        license = @License(name = "Chile API Terms and License", url = "http://misitio.cl/terms-of-service.html")
    ),
        ...
        return new OpenAPI()
            .info(
                new io.swagger.v3.oas.models.info.Info()
                    ...
                    .termsOfService(env.getProperty("springdoc.docs.terms", "http://misitio.cl/terms-of-service.html"))
                    .contact(
                        new io.swagger.v3.oas.models.info.Contact()
                            .name("misitio")
                            .email("support@misitio.cl")
                    )
                    .license(
                        new io.swagger.v3.oas.models.info.License()
                            .name("Chile API Terms and License")
                            .url("http://misitio.cl/terms-of-service.html")
                    )
            )
            .components(
                new Components()
